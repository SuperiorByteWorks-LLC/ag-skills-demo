# Agri Data Toolkit Agentic Development Space

> Complete guide to AI-assisted development with transparent workflows, human guardrails, and operational awareness.

## Overview

This folder contains all files needed for agents to work on Agri Data Toolkit projects:
...
6. **[custom-instructions.md](custom-instructions.md)**
   - Agri Data Toolkit-specific rules
