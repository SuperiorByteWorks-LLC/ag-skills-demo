# Gearing Up: Building Your Smart Farm Workspace + Demo (Class 02)
...
- **Class**: 02 – Gearing Up: Building Your Smart Farm Workspace + Demo  
- **Instructor**: Clayton Young
...
2. **Python & key libraries (pandas, geopandas, etc.)**
3. **Git & GitHub workflows**
4. **VS Code & AI assistant integration**
5. **Demo: Setting up your workspace**

---

## Slide 5 – Development Environment Setup

> **Section Overview**: Installing and configuring Python, virtual environments, and package managers.

- _Content to be developed._

---

## Slide 6 – Python & Key Libraries

> **Section Overview**: Overview of pandas, geopandas, matplotlib, rasterio, and other core libraries.

- _Content to be developed._

---

## Slide 7 – Git & GitHub Workflows

> **Section Overview**: Version control fundamentals, branching, committing, and collaboration.

- _Content to be developed._

---

## Slide 8 – VS Code & AI Assistant Integration

> **Section Overview**: Setting up VS Code with Copilot, Roo Code, and other AI plugins.

- _Content to be developed._

---

## Slide 9 – Demo: Setting Up Your Workspace

> **Live Demo**: Walk through installing tools, cloning the agri-data-toolkit repo, running the data download script.
...
- Focus on getting your environment configured and ready for upcoming workshops.
