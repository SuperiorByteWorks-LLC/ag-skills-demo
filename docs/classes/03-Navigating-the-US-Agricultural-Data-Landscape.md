# Navigating the US Agricultural Data Landscape + Workshop (Class 03)
...
- **Class**: 03 – Navigating the US Agricultural Data Landscape + Workshop
- **Instructor**: Clayton Young
...
1. **Overview of US agricultural data sources**
2. **Data collection methods & formats**
3. **File formats & access patterns**
4. **Spatial data fundamentals**
5. **Workshop: Accessing & downloading US data**

---

## Slide 5 – Overview of US Agricultural Data Sources

> **Section Overview**: Key government and private data repositories (USDA, NASS, NOAA, etc.).

- _Content to be developed._

---

## Slide 6 – Data Collection Methods & Formats

> **Section Overview**: How agricultural data is collected, processed, and standardized.

- _Content to be developed._

---

## Slide 7 – File Formats & Access Patterns

> **Section Overview**: CSV, GeoJSON, NetCDF, and other common formats; API vs. download strategies.

- _Content to be developed._

---

## Slide 8 – Spatial Data Fundamentals

> **Section Overview**: Coordinate systems, shapefiles, rasters, and spatial indexing.

- _Content to be developed._

---

## Slide 9 – Workshop: Accessing & Downloading US Data

> **Hands-on Workshop**: Students practice downloading data from USDA, NASS, and other sources.

- _Instructor-led workshop with code examples._

---

## Assignment (Class 03)

**Title**: US Data Source Survey  
**Due Date**: _TBD_  
**Points**: _xx_

**Description**:

- Identify and document 3–5 relevant US agricultural data sources for your region.
- Download a sample dataset from each.
- Document access method, file format, and metadata.
