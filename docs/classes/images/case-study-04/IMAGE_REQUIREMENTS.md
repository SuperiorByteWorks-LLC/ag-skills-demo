# Image Requirements: Case Study 1.04 - John Deere Operations Center

This document specifies image requirements for the John Deere Operations Center case study slides and supporting materials.
...
4. Custom illustrations/diagrams created for course
...
Used with permission for educational purposes / © John Deere [Year]
```
...
- Create mockup based on public documentation
...
Educational use / © John Deere [Year]
```
...
Based on publicly available John Deere technical documentation
```
...
Created for Agricultural Data Systems course / [Year]
Based on agricultural data ethics literature and case study analysis
```
...
- U.S. map showing states with:
  ...
  - No legislation (gray)
- Timeline of key right-to-repair milestones
...
License: [Specify] / Used with permission for educational purposes
```
...
- Use of trademarked images for education is generally fair use, but:
  ...
  - Don't imply endorsement by Deere
  - Use minimal branding necessary to illustrate concepts
...
4. Use professional color scheme (avoid looking like official Deere materials)
5. Test legibility when projected
...
2. If taking screenshots:
   ...
   - Remove all personal/identifiable farm data
   - Capture at high resolution
   - Crop to relevant interface elements
...
3. Export at 1920x1080 resolution
4. Verify all data points are accurately represented
...
4. Document source, photographer, license clearly
5. Save original and any edited versions separately
...
```
case-study-04-[number]-[description].png

Examples:
case-study-04-01-connected-equipment.png
case-study-04-02-operations-center-dashboard.png
case-study-04-03-jdlink-data-flow.png
case-study-04-04-mobile-app-interface.png
case-study-04-05-subscription-tiers.png
case-study-04-06-data-ownership-tensions.png
case-study-04-07-right-to-repair-map.png
case-study-04-08-farmer-cab-technology.png
```
...
- [ ] License: Confirmed as appropriate for educational use
- [ ] Trademark use: Justified and properly attributed
- [ ] Fair use: Educational purpose clear
- [ ] Privacy: No personal farmer data visible
...
- [ ] Critical tone: Doesn't appear as marketing material

---

## Fair Use Justification (for reference)

Using John Deere trademarked images and interface screenshots in this course constitutes fair use under U.S. Copyright Law (17 U.S.C. § 107) because:

1. **Purpose:** Educational use for nonprofit university course
2. **Nature:** Factual information about agricultural technology systems
3. **Amount:** Using minimal necessary portions to illustrate concepts
4. **Effect:** No market harm to John Deere; critical analysis of public platform
...
- Cites publicly available sources
- Respects intellectual property rights while engaging in legitimate educational critique

**John Deere trademarks:**
John Deere, Operations Center, JDLink, and other product names are trademarks of Deere & Company. Use of these names is for educational identification purposes only.

---

**Document Status:** Image requirements defined, images to be sourced/created  
**Last Updated:** January 27, 2026  
**Contact:** Course instructor for questions about image sourcing, permissions, or fair use
