...
Input:  data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/tables/iowa_weather_2021_2025.csv
Output: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_weather_timeseries.png
data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_monthly_precip.png
data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_gdd_analysis.png
"""
...
def main():
    ...
    plt.tight_layout()
    plt.savefig(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_weather_timeseries.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_weather_timeseries.png"
    )
    ...
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_monthly_precip.png"
    )
    ...
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_gdd_analysis.png"
    )
