...
Output: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/summaries/iowa_field_summary.csv, summary stats
"""
...
def main():
    ...
    summary.to_csv(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/summaries/iowa_field_summary.csv",
        index=False,
    )
    print(
        "\n✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/summaries/iowa_field_summary.csv"
    )
