...
Output: data/growers/iowa-demo-grower/farms/iowa-demo-farm/fields/.../derived/reports/iowa_field_card_01.png through iowa_field_card_10.png
"""
...
def main():
    ...
    for idx, field in field_data.iterrows():
        ...
        card_num = idx + 1
        plt.savefig(
            f"data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_field_card_{card_num:02d}.png",
            dpi=150,
            bbox_inches="tight",
        )
        plt.close()
    ...
    print(
        "\n✓ All 10 field cards saved to: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/"
    )
