...
Input:  data/growers/iowa-demo-grower/farms/iowa-demo-farm/boundary/field_boundaries.geojson
data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/tables/iowa_10_fields_soil.csv
data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/tables/iowa_weather_2021_2025.csv
Output: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/summaries/iowa_correlation_matrix.csv
data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_correlation_heatmap.png
data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_xy_plots.png
"""
...
def main():
    ...
    os.makedirs("data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports", exist_ok=True)
    os.makedirs(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/summaries", exist_ok=True
    )

    fields = gpd.read_file(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/boundary/field_boundaries.geojson"
    )
    soil = pd.read_csv(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/tables/iowa_10_fields_soil.csv"
    )
    ...
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_correlation_heatmap.png"
    )

    # Save correlation matrix
    corr_matrix.to_csv(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/summaries/iowa_correlation_matrix.csv"
    )
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/summaries/iowa_correlation_matrix.csv"
    )
    ...
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_xy_plots.png"
    )
