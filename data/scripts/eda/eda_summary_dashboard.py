...
Output: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_summary_dashboard.png
"""
...
def main():
    ...
    plt.savefig(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_summary_dashboard.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_summary_dashboard.png"
    )
