...
Input:  data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/tables/iowa_10_fields_soil.csv
data/shared/cdl/derived/tables/iowa_2023_cdl.csv, data/shared/cdl/derived/tables/iowa_2024_cdl.csv
Output: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_soil_distributions.png
data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_cdl_distributions.png
"""
...
def main():
    ...
    cdl_2023 = pd.read_csv("data/shared/cdl/derived/tables/iowa_2023_cdl.csv")
    cdl_2024 = pd.read_csv("data/shared/cdl/derived/tables/iowa_2024_cdl.csv")
    ...
    plt.tight_layout()
    plt.savefig(
        "data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_soil_distributions.png",
        dpi=150,
        bbox_inches="tight",
    )
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_soil_distributions.png"
    )
    ...
    plt.close()
    print(
        "✓ Saved: data/growers/iowa-demo-grower/farms/iowa-demo-farm/derived/reports/iowa_cdl_distributions.png"
    )
