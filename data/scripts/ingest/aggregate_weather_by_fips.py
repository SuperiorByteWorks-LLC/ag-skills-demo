...
def _build_lower48_county_weather(
    ...
    *,
    ...
    return county_weather, failures
...
def _build_field_mapped_county_weather(
    *,
    ...
    weather_csv = farm_table_path(grower_slug, farm_slug, "iowa_weather_2021_2025.csv")
...
def main() -> int:
    ...
    if args.coverage in {"traditional-corn-belt", "lower48"}:
        county_weather, failure_count = _build_lower48_county_weather(
            scoped_lookup,
            year=args.year,
